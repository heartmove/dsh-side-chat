...
export const zh = {
  ...
  'panel.error': '侧边聊天出错',
  'panel.running': '思考中…',
  'panel.questionHint': '主会话有一个待回答的问题弹框',
  'panel.questionAsk': '在侧边聊天里问这个弹框',
  'panel.questionAsking': '询问中…',
  'panel.copy': '复制',
  'panel.copied': '已复制',
  'panel.think': '思考',
  'panel.commands': '命令',
...
export const en = {
  ...
  'panel.questionHint': 'The main conversation has a pending question dialog',
  'panel.questionAsk': 'Ask about this dialog in the side chat',
  'panel.questionAsking': 'Asking…',
  'panel.copy': 'Copy',
  'panel.copied': 'Copied',
  'panel.think': 'Think',
